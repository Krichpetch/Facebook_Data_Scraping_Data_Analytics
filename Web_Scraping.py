...
url = 'https://www.facebook.com/groups/1975972302632768'
driver.get(url)
...
def scrape_facebook_posts(driver):
    ...
    for _ in range(10):  # Adjust the number of times as needed
...
df.to_csv("facebook_posts.csv", index=False, encoding='utf-8-sig')
